    ...
    <head>
        ...
        <style type="text/css">
            ...
            .login-reg-panel{
                ...
                margin:auto;
                height:400px;
                background-color: #bb242f; /*ini yg diganti dari oren ke merah*/
            }
            .white-panel{
    ...
    <body>
        <%Cookie[] cookies = request.getCookies();
            ...
            if (cookies != null) {
                for (Cookie cookie : cookies) {
                    if (cookie.getName().equals("cookieLoginUserResto")) {
                        name = cookie.getValue();
                    }
                    if (cookie.getName().equals("cookieLoginPasswordResto")) {
        ...
        <div class="login-reg-panel">
            <div class="login-info-box">
                ...
                <p>Yuk masuk dan kelola restoranmu.</p>
            ...
            <div class="register-info-box">
                ...
                <p>Daftar dan promosikan restoranmu disini.</p>
            ...
            <div class="white-panel">
                <div class="login-show">
                    <h2>MASUK</h2>
                    <form method="post" action="./LoginServlet" name="loginForm" id="loginForm">
                        <input type="text" placeholder="Nama Pengguna" name="idResto" value="<%=name%>">
                        <input type="password" placeholder="Kata Sandi" name="password" value="<%=pass%>">
                ...
                <div class="register-show">
                    <h2>DAFTAR</h2>
                    <form method="post" action="./DaftarRestoPart2">
                        <input type="text" placeholder="Email" name ="emailR" required>
