 ...
 */
public class LihatJadwalServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            synchronized (session) {
                ...
                jadwal.setJamMeja(jDao.getAllMeja(resto.getIdResto()));
                request.setAttribute("jadwal", jadwal);
                RequestDispatcher rd = request.getRequestDispatcher("/EditJamReservasi.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LihatJadwalServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
