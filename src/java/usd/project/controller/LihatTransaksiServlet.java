...
import usd.project.model.ListPengunjung;
 ...
 */
public class LihatTransaksiServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ListPengunjung dp = new ListPengunjung();
            ...
            synchronized (session) {
                ...
                di.setInvoice(iDao.getAllInvLunas(resto.getIdResto()));
                request.setAttribute("daftarInvoice", di);
                dp.setDaftarPengunjung(service.findListPengunjungTransaksi(di));
                request.setAttribute("daftarPengunjung", dp);
                dm.setDaftarMeja(service.findListMejaTransaksi(di));
                request.setAttribute("daftarMeja", dm);
                RequestDispatcher rd = request.getRequestDispatcher("/transaksi.jsp");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(LihatTransaksiServlet.class.getName()).log(Level.SEVERE, null, ex);
